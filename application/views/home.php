...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="<?= base_url('assets/home/assets/img/favicon.ico') ?>">
    ...
    <link rel="stylesheet" href="<?= base_url('assets/home/assets/css/progressbar_barfiller.css') ?>">
    <link rel="stylesheet" href="<?= base_url('assets/home/assets/css/gijgo.css') ?>">
    <link rel="stylesheet" href="<?= base_url('assets/home/assets/css/animate.min.css') ?>">
    <link rel="stylesheet" href="<?= base_url('assets/home/assets/css/animated-headline.css') ?>">
    <link rel="stylesheet" href="<?= base_url('assets/home/assets/css/magnific-popup.css') ?>">
    <link rel="stylesheet" href="<?= base_url('assets/home/assets/css/fontawesome-all.min.css') ?>">
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="single-cat text-center">
                            <div class="cat-icon">
                                <img src="<?= base_url('assets/home/assets/img/icon/services-icon1.svg') ?>" alt="">
                            </div>
                            <div class="cat-cap">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="single-cat text-center">
                            <div class="cat-icon">
                                <img src="<?= base_url('assets/home/assets/img/icon/services-icon2.svg') ?>" alt="">
                            </div>
                            <div class="cat-cap">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="single-cat text-center">
                            <div class="cat-icon">
                            <img src="<?= base_url('assets/home/assets/img/icon/services-icon3.svg') ?>" alt="">
                ...
                <div class="row no-gutters">
                    <div class="col-lg-6 col-md-6">
                        <div class="single-offers">
                            <img src="<?= base_url('assets/home/assets/img/gallery/offers1.png') ?>" alt="" class="w-100">
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6">
                        <div class="single-offers">
...
<script src="<?= base_url('assets/home/assets/js/animated.headline.js') ?>"></script>
<script src="<?= base_url('assets/home/assets/js/jquery.magnific-popup.js') ?>"></script>

<!-- Date Picker -->
<script src="<?= base_url('assets/home/assets/js/gijgo.min.js') ?>"></script>
<!-- Nice-select, sticky -->
<script src="<?= base_url('assets/home/assets/js/jquery.nice-select.min.js') ?>"></script>
<script src="<?= base_url('assets/home/assets/js/jquery.sticky.js') ?>"></script>
<!-- Progress -->
<script src="<?= base_url('assets/home/assets/js/jquery.barfiller.js') ?>"></script>
...
<script src="<?= base_url('assets/home/assets/js/jquery.countdown.min.js') ?>"></script>
<script src="<?= base_url('assets/home/assets/js/hover-direction-snake.min.js') ?>"></script>
